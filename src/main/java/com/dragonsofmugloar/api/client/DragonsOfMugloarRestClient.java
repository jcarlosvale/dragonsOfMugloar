...
/**
 * The class to abstract the http methods and used to connect to REST API
 */
@Log
public class DragonsOfMugloarRestClient {
    ...
    public MessageOfBoardDTO [] getAllMessagesFromMessageBoard(String gameId) throws CustomException {
        ...
        return restClient.get(url, MessageOfBoardDTO[].class, gameId);
    }

    public MessageAfterSolveDTO solveTask(String gameId, String adId) throws CustomException {
    ...
    public MessageAfterBuyItemShop buyItem(String gameId, String productId) throws CustomException {
